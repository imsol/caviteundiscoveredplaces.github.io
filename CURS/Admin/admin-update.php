          ...
          ?>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><label>Firstname</label><input type="text" class="input1" value="<?PHP echo $st_row['firstname'] ?>" name="firstname"> </td>
                </tr>
                <tr>
                  
                    <td>  <label>Middlename</label><input type="text" class="input1" value="<?PHP echo $st_row['middlename'] ?>" name="middlename" > </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td> <label>Contact No</label><input type="number" class="input1" value="<?PHP echo $st_row['phone_no'] ?>" name="contact" ></td>
                </tr>
                <tr>
                   
                    <td> <label>Address</label><input type="text" class="input1" value="<?PHP echo $st_row['addr'] ?>" name="address" > </td>
                </tr>
                <tr>
